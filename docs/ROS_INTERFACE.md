...
| `/perception/lidar/cones` | `wuta_msgs/msg/ConeArray` | 默认 lidar_detection；模拟颜色模式为 simulated_cone_colorizer | cone_map_builder | 随点云；独立后融合模式改订阅 `/perception/fused/cones`；depth 10 |
